        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EthAccountAddress = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EstateImageName = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EstateStatusName = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BuyerOK = table.Column<bool>(nullable: false),
                    SellerOK = table.Column<bool>(nullable: false),
                    BuyerOKTime = table.Column<DateTime>(type: "smalldatetime", nullable: true),
                    SellerOKTime = table.Column<DateTime>(type: "smalldatetime", nullable: true),
                    SaveTime = table.Column<DateTime>(type: "smalldatetime", nullable: false),
                    Note = table.Column<string>(nullable: true),
                    Amount = table.Column<int>(nullable: false),
                    EstatesId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EstateContracts", x => x.EstateContractId);
                    table.ForeignKey(
                        name: "FK_EstateContracts_Estates_EstatesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RequestEstate", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EstateContracts_EstatesId",
